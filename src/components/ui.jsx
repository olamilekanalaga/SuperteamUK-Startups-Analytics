...
export function Menu({ label, trigger, children, align = "end", contentClassName = "" }) {
  return (
...
export function Select({
  ...
  return (
    <Dropdown.Root modal={modal}>
      <Dropdown.Trigger className={triggerClassName} aria-label={label}>
...
export function Tabs({ id, label, items, value, onChange, className = "", indicatorMotion }) {
  ...
  return (
    ...
    >
      ...
      {className.split(" ").includes("source-tabs") && <TabIndicator navRef={navRef} value={value} motion={indicatorMotion} />}
    </nav>
  );
}
